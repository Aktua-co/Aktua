...
class MobileBienvenida extends StatefulWidget {
  const MobileBienvenida({ Key? key }) : super(key: key);

  @override
  _MobileBienvenidaState createState() => _MobileBienvenidaState();
}

class _MobileBienvenidaState extends State<MobileBienvenida> {
  @override
